...
- La skill local `.codex/skills/crear-cuaderno-fotografia` crea y traduce los comentarios narrativos extensos de una ficha sin duplicar su introducción ni los datos técnicos del YAML.
