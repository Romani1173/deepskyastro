...
- El planificador de visibilidad es una herramienta privada: debe estar disponible únicamente durante el desarrollo local en `localhost`; nunca debe enlazarse ni generarse en la publicación pública de Cloudflare o GitHub Pages. Conservar en local sus alias y objetivos pendientes.
