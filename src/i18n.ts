...
export const copy = {
	ca: {
		...
		home: 'Inici', catalogue: 'Galeria', articles: 'Articles', visibilityPlanner: 'Visibilitat', equipmentAnalyzer: 'Analitzador', planning: 'Planificació', myEquipment: 'El meu equip', siteMap: 'Descobreix la web', all: 'Tots', backHome: 'Tornar a la portada', backCatalogue: 'Tornar a la galeria',
	...
	es: {
		...
		home: 'Inicio', catalogue: 'Galería', articles: 'Artículos', visibilityPlanner: 'Visibilidad', equipmentAnalyzer: 'Analizador', planning: 'Planificación', myEquipment: 'Mi equipo', siteMap: 'Descubre la web', all: 'Todas', backHome: 'Volver a la portada', backCatalogue: 'Volver a la galería',
	...
	en: {
		...
		home: 'Home', catalogue: 'Gallery', articles: 'Articles', visibilityPlanner: 'Visibility', equipmentAnalyzer: 'Analyser', planning: 'Planning', myEquipment: 'My equipment', siteMap: 'Discover the website', all: 'All', backHome: 'Back to the home page', backCatalogue: 'Back to the gallery',
