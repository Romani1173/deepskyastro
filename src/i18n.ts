...
export const copy = {
	ca: {
		...
		home: 'Inici', catalogue: 'Galeria', articles: 'Articles', visibilityPlanner: 'Visibilitat', equipmentAnalyzer: 'Analitzador', planning: 'Planificació', myNight: 'La meva nit', myEquipment: 'El meu equip', siteMap: 'Descobreix la web', all: 'Tots', backHome: 'Tornar a la portada', backCatalogue: 'Tornar a la galeria',
		...
		homeSessionPreparation: 'Prepara la sessió', homeSessionPreparationTooltip: 'Descobreix objectius, comprova l’enquadrament del teu equip i planifica la captura.',
		generalInfo: 'Informació general', photoNotebook: 'Quadern de la fotografia', category: 'Categoria', date: 'Data', captureSessions: 'Sessions de captura', capture: 'Captura', totalTime: 'Temps total', subframes: 'Subframes', gainOffset: 'Guany / Offset', calibration: 'Calibratge',
	...
	es: {
		...
		home: 'Inicio', catalogue: 'Galería', articles: 'Artículos', visibilityPlanner: 'Visibilidad', equipmentAnalyzer: 'Analizador', planning: 'Planificación', myNight: 'Mi noche', myEquipment: 'Mi equipo', siteMap: 'Descubre la web', all: 'Todas', backHome: 'Volver a la portada', backCatalogue: 'Volver a la galería',
		...
		homeSessionPreparation: 'Prepara tu sesión', homeSessionPreparationTooltip: 'Descubre objetivos, comprueba el encuadre de tu equipo y planifica la captura.',
		generalInfo: 'Información general', photoNotebook: 'Cuaderno de la fotografía', category: 'Categoría', date: 'Fecha', captureSessions: 'Sesiones de captura', capture: 'Captura', totalTime: 'Tiempo total', subframes: 'Subframes', gainOffset: 'Ganancia / Offset', calibration: 'Calibración',
	...
	en: {
		...
		home: 'Home', catalogue: 'Gallery', articles: 'Articles', visibilityPlanner: 'Visibility', equipmentAnalyzer: 'Analyser', planning: 'Planning', myNight: 'My night', myEquipment: 'My equipment', siteMap: 'Discover the website', all: 'All', backHome: 'Back to the home page', backCatalogue: 'Back to the gallery',
		...
		homeSessionPreparation: 'Prepare your session', homeSessionPreparationTooltip: 'Discover targets, check your equipment framing and plan the capture.',
		generalInfo: 'General information', photoNotebook: 'Photograph notebook', category: 'Category', date: 'Date', captureSessions: 'Capture sessions', capture: 'Capture', totalTime: 'Total time', subframes: 'Subframes', gainOffset: 'Gain / Offset', calibration: 'Calibration',
...
export const sessionPreparationCopy = {
	ca: { eyebrow: 'Recorregut de preparació', title: 'Prepara la teva sessió', intro: 'Tres eines relacionades, però independents. Pots començar per qualsevol punt segons el que necessitis.', start: 'Pots començar per qualsevol eina', visibility: 'Descobreix objectius', visibilityHelp: 'Compara què pots fotografiar durant una setmana des de la ubicació de referència.', analyser: 'Comprova el teu equip', analyserHelp: 'Calcula el camp de visió i comprova com encaixa un objecte en el teu enquadrament.', planning: 'Planifica la captura', planningHelp: 'Estudia un objecte durant set nits des de la ubicació que triïs.', openVisibility: 'Obre l’eina Visibilitat', openAnalyser: 'Obre l’eina Analitzador d’equip', openPlanning: 'Obre l’eina Planificació', returnToSession: 'Torna a Prepara la teva sessió', openSession: 'Prepara la teva sessió', returnToVisibility: 'Torna a Visibilitat' },
	es: { eyebrow: 'Recorrido de preparación', title: 'Prepara tu sesión', intro: 'Tres herramientas relacionadas, pero independientes. Puedes comenzar por cualquier punto según lo que necesites.', start: 'Puedes comenzar por cualquier herramienta', visibility: 'Descubre objetivos', visibilityHelp: 'Compara qué puedes fotografiar durante una semana desde la ubicación de referencia.', analyser: 'Comprueba tu equipo', analyserHelp: 'Calcula el campo de visión y comprueba cómo encaja un objeto en tu encuadre.', planning: 'Planifica la captura', planningHelp: 'Estudia un objeto durante siete noches desde la ubicación que elijas.', openVisibility: 'Abrir herramienta Visibilidad', openAnalyser: 'Abrir herramienta Analizador de equipo', openPlanning: 'Abrir herramienta Planificación', returnToSession: 'Volver a Prepara tu sesión', openSession: 'Prepara tu sesión', returnToVisibility: 'Volver a Visibilidad' },
	en: { eyebrow: 'Preparation path', title: 'Prepare your session', intro: 'Three related but independent tools. Start at whichever point matches what you need.', start: 'You can start with any tool', visibility: 'Discover targets', visibilityHelp: 'Compare what you can photograph during a week from the reference location.', analyser: 'Check your equipment', analyserHelp: 'Calculate the field of view and see how a target fits within your frame.', planning: 'Plan the capture', planningHelp: 'Study one target over seven nights from a location of your choice.', openVisibility: 'Open Visibility tool', openAnalyser: 'Open Equipment analyser', openPlanning: 'Open Planning tool', returnToSession: 'Back to Prepare your session', openSession: 'Prepare your session', returnToVisibility: 'Back to Visibility' },
} as const;
...
export const equipmentAnalyzerGuideHref = (lang: Lang, base = '/') => lang === 'ca'
	? pageHref('laboratori/analitzador-equip/guia', base)
	: lang === 'es' ? pageHref('es/laboratorio/analizador-equipo/guia', base) : pageHref('en/lab/equipment-analyser/guide', base);
