...
export const copy = {
	...
	es: {
		...
		viewPhoto: 'Ver la ficha de', astroPhoto: 'Fotografía astronómica de', constellation: 'Constelación', exposure: 'Exposición', includesProcess: 'Incluye el flujo de posprocesado', featureLegend: 'Indicadores disponibles', processIndicator: 'Flujo de posprocesado', visibilityIndicator: 'Visibilidad anual', visibilityTooltip: (period: string) => `Visibilidad a lo largo del año a las 00:00 UTC. Por encima de 30°: ${period}.`, homeVisibilityTooltip: 'Listado de los objetos visibles durante la semana seleccionada, con la gráfica anual y la noche astronómica de la fecha elegida.', openDirect: 'Abrir directamente', featurePreview: 'Vista ampliada del recurso',
